...
const navigation = [
	{name: 'Clients', href: '/admin/clients', current: true},
	{name: 'Subjects', href: '/admin/subjects', current: false},
...
export default function Header(){
	...
	return (<Disclosure as="nav" className="bg-gray-800 w-full fixed top-0 z-50 shadow-md">
			...
			<div className="relative flex h-16 items-center justify-between">
				...
				<div
					...
					<div className="flex shrink-0 items-center">
						<h1 className="h-8 w-auto text-xl text-white font-semibold cursor-pointer"
							onClick={() => router.push('/admin')}>Encourse</h1>
					</div>
